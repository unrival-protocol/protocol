...
SOURCE_PATH=$HOME/projects/github/documentation/source/protocol
ls ${SOURCE_PATH}
BUILD_PATH=$HOME/projects/github/protocol

# export to gihut readable markdown

echo "$SOURCE_PATH"
echo "$BUILD_PATH"
$HOME/.cargo/bin/obsidian-export "$SOURCE_PATH" "$BUILD_PATH"
